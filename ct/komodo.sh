#!/usr/bin/env bash
source <(curl -fsSL https://raw.githubusercontent.com/pmajkutewicz/ProxmoxVE/main/misc/build.func)
...
function update_script() {
  ...
  if [[ "$COMPOSE_BASENAME" == "sqlite.compose.yaml" || "$COMPOSE_BASENAME" == "postgres.compose.yaml" ]]; then
    ...
    echo -e "${BGN}https://github.com/pmajkutewicz/ProxmoxVE/discussions/5689${CL}\n"
    exit 1
  fi
