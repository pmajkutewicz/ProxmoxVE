...
1. **Clone the repository**
   ...
   ```bash
   git clone https://github.com/pmajkutewicz/ProxmoxVE.git
...
- **[Community Scripts Repository](https://github.com/pmajkutewicz/ProxmoxVE)**
- **[Discord Community](https://discord.gg/2wvnMDgdnU)**
- **[GitHub Discussions](https://github.com/pmajkutewicz/ProxmoxVE/discussions)**
...
- **📝 Change Log**: [https://github.com/pmajkutewicz/ProxmoxVE/blob/main/CHANGELOG.md](https://github.com/pmajkutewicz/ProxmoxVE/blob/main/CHANGELOG.md)
