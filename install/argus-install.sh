...
service:
  ...
  pmajkutewicz/ProxmoxVE:
    latest_version:
      type: github
      url: pmajkutewicz/ProxmoxVE
      use_prerelease: false
    dashboard:
      icon: https://raw.githubusercontent.com/pmajkutewicz/ProxmoxVE/refs/heads/main/misc/images/logo.png
      icon_link_to: https://helper-scripts.com/
      web_url: https://github.com/pmajkutewicz/ProxmoxVE/releases
EOF
msg_ok "Setup Config"
